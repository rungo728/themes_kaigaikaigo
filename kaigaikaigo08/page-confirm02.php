...
<head>
	...
	<title>お問い合わせ入力確認｜ZENKEN介護</title>
	<?php get_header(); ?>
	<?php wp_head() ?>
</head>
...
<body id="form">
	...
	<div class="visArea_form inquiry">
		<div class="mainArea">
	...
	<div id="contents-wrapper" class="form">
		<div class="contents">
			...
			<div class="form_inner">
				<div class="form_inputBox inquiry confirm">
					<div class="form-head">
						<div class="head__inner">
							<div class="form-tit">入力内容 確認</div>
						</div>
					</div>
					<?php echo do_shortcode('[contact-form-7 id="aa8d00e" title="お問い合わせ確認"]'); ?>
				</div>
			</div>
		</div>
	</div>
