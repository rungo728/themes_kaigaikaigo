...
//title
global $title;
$title = "ZENKEN介護 | 海外介護人材紹介から日本語教育まで。海外介護人材の悩みをすべて解決！";

//description
global $description;
$description = "Zenken介護は、海外介護人材の紹介から受け入れ、日本語教育、国家資格取得、日本人スタッフの研修までをワンストップでフルサポート。人材不足、定着に悩む介護施設の課題を解決します。";
...
<div class="l-intro">
  <div class="l-inner">
    ...
    <div class="box">
      ...
      <img class="pc" src="<?php echo get_template_directory_uri(); ?>/img/img_caution_pc.png" alt="">
      <img class="sp" src="<?php echo get_template_directory_uri(); ?>/img/img_caution_sp.png" alt="">
    </div>
  </div><!-- /.l-inner -->
</div><!-- /.l-intro -->
<div class="l-problem">
...
<div class="l-eightFeature">
  ...
  <div class="l-inner">
    <h2 class="eightFeature-catch">
      <span>ZENKEN介護</span>
      <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeatureCatch.png" alt="8つ">
      <span>の特徴</span>
    </h2>
    <div class="eightFeature-box-wrapper">
      <div class="card card01">
        <div class="imgWrap">
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature01.png" alt="">
        </div>
      ...
      <div class="card card02">
        <div class="imgWrap">
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature02.png" alt="">
        </div>
      ...
      <div class="card card03">
        <div class="imgWrap">
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature03.png" alt="">
        </div>
      ...
      <div class="card card04">
        <div class="imgWrap">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature04.png" alt="">
        </div>
        <p>
      ...
      <div class="card card05">
        <div class="imgWrap">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature05.png" alt="">
        </div>
      ...
      <div class="card card06">
        <div class="imgWrap">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature06.png" alt="">
        </div>
      ...
      <div class="card card07">
        <div class="imgWrap">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature07.png" alt="">
        </div>
      ...
      <div class="card card08">
        <div class="imgWrap">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/eightFeature08.png" alt="">
        </div>
        ...
        <tbody>
          ...
          <tr>
            <td rowspan="7" class="vertical-orange">
              <img src="<?php echo get_template_directory_uri(); ?>/img/vertical-text--kaigai.png" alt="海外人材採用">
            </td>
            <th>海外での育成</th>
            <td>
              <img src="<?php echo get_template_directory_uri(); ?>/img/table-orange-check.png" alt="">
            </td>
            <td></td>
            <td></td>
            <td>
              <img src="<?php echo get_template_directory_uri(); ?>/img/table-gray-check.png" alt="">
            </td>
          </tr>
          <tr>
            <th>海外での現場実習</th>
          ...
          <tr>
            <td rowspan="6" class="vertical-green">
              <img src="<?php echo get_template_directory_uri(); ?>/img/vertical-text--nihongo.png" alt="日本語教育プログラム">
            </td>
            <th>通期開催</th>
            <td>
              <img src="<?php echo get_template_directory_uri(); ?>/img/table-orange-check.png" alt="">
      ...
      <div class="facilitySample">
        ...
        <div class="facilityImgWrap">
          <div class="facilityImgBox">
            <img src="<?php echo get_template_directory_uri(); ?>/img/facilitySample1.png" alt="">
          ...
          <div class="facilityImgBox">
            <img src="<?php echo get_template_directory_uri(); ?>/img/facilitySample2.png" alt="">
            <div class="facilityImgText">
          ...
          <div class="facilityImgBox">
            <img src="<?php echo get_template_directory_uri(); ?>/img/facilitySample3.png" alt="">
            <div class="facilityImgText">
